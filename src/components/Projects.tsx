...
const projects = [
  ...
  {
    id: 2,
    title: "Монтаж напольного унитаза с инсталляцией",
  ...
  {
    id: 4,
    title: "Установка унитаза с микролифтом",
    category: "Квартира",
      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-16">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight">Примеры установки</h2>
          </div>
          <a
            href="#"
