    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Сантехнические услуги"}</p>
          ...
          >
            {"Установка унитазов"}
            <br />
            <span className="text-orange-200">{"с выездом на дом"}</span>
          </h1>
        </div>
      </div>
